<p align="center">
  <a href="https://mojojs.org">
    <picture>
      <source srcset="https://github.com/dramaorg/ipsum-harum-ipsa/blob/main/docs/images/logo-dark.png?raw=true" media="(prefers-color-scheme: dark)">
      <img src="https://github.com/dramaorg/ipsum-harum-ipsa/blob/main/docs/images/logo.png?raw=true" style="margin: 0 auto;">
    </picture>
  </a>
</p>

[![](https://github.com/dramaorg/ipsum-harum-ipsa/workflows/test/badge.svg)](https://github.com/dramaorg/ipsum-harum-ipsa/actions)
[![Coverage Status](https://coveralls.io/repos/github/dramaorg/ipsum-harum-ipsa/badge.svg?branch=main)](https://coveralls.io/github/dramaorg/ipsum-harum-ipsa?branch=main)
[![npm](https://img.shields.io/npm/v/@dramaorg/ipsum-harum-ipsa.svg)](https://www.npmjs.com/package/@dramaorg/ipsum-harum-ipsa)
...
[latest developments](https://github.com/dramaorg/ipsum-harum-ipsa/blob/main/CHANGELOG.md) join us on
...
```
$ npm install @dramaorg/ipsum-harum-ipsa
```
...
```js
import mojo from '@dramaorg/ipsum-harum-ipsa';
